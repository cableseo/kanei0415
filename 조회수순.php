  ...
  <div style="padding-top:10px;">
    ...
    <div id="board_area">
      ...
      <div id="sort_btn1"style="padding:0.5rem;">
        ...
        echo  "<a href=\"조회수순.php\"><button>views</button></a>";
        echo " ";
        echo  "<a href=\"방번호순.php\"><button>number</button></a>";
        }else{
          echo  "<a href=\"/조회수순.php?category=".$category."\"><button>views</button></a>";
          echo " ";
          echo  "<a href=\"/방번호순.php?category=".$category."\"><button>number</button></a>";
        }?>
      ...
      <table class="list-table">
        <thead>
          ...
          // room테이블에서 idx를 기준으로 내림차순해서 10개까지 표시
            if(@is_null($category)){
              $sql = query("select * from room order by 조회수 desc limit 0,20");
            }else{
              $sql = query("select * from room where 카테고리 = '$category' order by 조회수 desc limit 0,20");
            }
